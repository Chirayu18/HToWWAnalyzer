...
static constexpr auto s_tag = "[GenLevelInfoAnalyzer]";

TEST_CASE("Standard checks of GenLevelInfoAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("GenLevelInfoAnalyzer"
